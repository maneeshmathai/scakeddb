 ...
 */
class MovesActivityDetails extends \Entities\MovesActivityDetails implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setMovesActivity($movesActivity);
    }

    public function getMovesActivity()
    {
        $this->__load();
        return parent::getMovesActivity();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'activity', 'steps', 'distance', 'movesActivity');
    }
